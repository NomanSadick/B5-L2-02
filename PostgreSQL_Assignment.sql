-- Active: 1748234804719@@127.0.0.1@5432@conservation_db
-- 1. Rangers
...
-- 3️. Find all sightings where the location includes "Pass".
SELECT *
FROM sightings
WHERE location LIKE '%Pass%';


-- 4️. List each ranger's name and their total number of sightings.
...
-- 5️. List species that have never been sighted.
...
-- 7️. Update all species discovered before year 1800 to have status 'Historic'.
UPDATE species
